        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <?}?>
<!--                    <button type="button" id="idxgo" class="btn btn-primary" data-url="/admin/cmss-order" data-count="/admin/cmss-count" data-page="--><?//=$page?><!--">순서 저장하기</button></a>-->
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tr class="headings">
                                <?foreach($col as $row) {?>
                                    ...
                                    <?if($row == '성명'):?>
                                        <th class="column-title" style="width: 40%;"> <?=$row?> </th>
                                    <?else:?>
...
<script>
    $('body').on('click', '.adminedit', function() {
        ...
        location.href = '/admin/cms-edit/'+idx;
    });
    $('body').on('click', '.admindel', function() {
        var con = confirm("정말 삭제하시겠습니까?");
        if(con) {
            var idx = $(this).parent().parent().attr('data-idx');
            var result = jsonreturn('/admin/cms-del/'+idx);
