                    ...
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left insu">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> 협력 법인 <span class="required">*</span></label>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <?if(!empty($data)) { $id = "historycollabo_edit"; $text = "수정하기"; } else { $id = "historycollabo_go"; $text = "등록하기";}?>
