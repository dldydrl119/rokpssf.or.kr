                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form class="form-horizontal form-label-left form-group news">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="file"> 썸네일 이미지 <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="file" id="thumbnail_image" required="required">
                                    <input type = "hidden" class = "req" name="image" value="<?=isset($data->thumbnail) ? $data->thumbnail : ''?>">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <?if(!empty($data)){ $id = "gallery_edit"; $text = "수정하기";} else { $id = "gallery_go"; $text = "등록하기"; }?>
